...
const TourDetailsPage = () => {
  ...
  const itinerary = [
    ...
    },
    {
      ...
      duration: "30 min",
      description:
        "Conclude your two-day excursion with a comfortable transfer back to your hotel or preferred location.",
    },
  ];
            ...
            <div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-center text-gray-500">
                  ...
                  <span>2 Days (8-10 hrs each)</span>
                </div>
              </div>
            </div>
                      ...
                      <div className="bg-gradient-to-r from-amber-50 to-blue-50 rounded-xl p-6 mb-6 border border-amber-100">
                        <div className="flex items-start gap-3">
                          ...
                          <p className="text-gray-700">
                            ...
                            Start both days early in the
                            morning to make the most of your
                            experience and avoid crowds at
                            popular attractions.
                          </p>
                        </div>
                      </div>
                      <p className="text-lg text-gray-700 mb-6">
                        Experience the best of Amritsar with
                        this immersive two-day excursion. On
                        Day 1, visit the poignant
                        Jallianwala Bagh, the majestic
                        Golden Temple, the insightful
                        Partition Museum, and witness the
                        electrifying Wagah Border ceremony.
                        Day 2 takes you on a culinary
                        adventure with a Food Walking Tour,
                        a Heritage Walk through the city's
                        historic lanes, visits to the sacred
                        Durgiana Mandir, and the iconic
                        Gobindgarh Fort (entry ticket not
                        included). Enjoy expert guidance,
                        comfortable transfers, and a
                        well-organized itinerary for a truly
                        memorable Amritsar experience.
                      </p>
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      },
                      {
                        ...
                        description:
                          "Explore history, spirituality, culture, and cuisine in one package",
                        icon: "📅",
                      },
                    ].map((feature, index) => (
                      <div
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            <div className="p-8 md:p-10">
              <h2 className="text-3xl font-bold text-white mb-4">
                Experience the Best of Amritsar in Two Days
              </h2>
              <p className="text-xl text-blue-100 mb-6 max-w-xl">
                Join thousands of travelers who have
                discovered the rich history, culture, and
                flavors of Amritsar through our
                comprehensive two-day tour.
              </p>
