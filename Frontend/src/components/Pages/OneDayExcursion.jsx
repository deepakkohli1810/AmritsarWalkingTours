...
const TourDetailsPage = () => {
  ...
  const highlights = [
    ...
    "Guided walk through Heritage Street and local bazaars",
    "Opportunities for photo stops at iconic landmarks",
    "Tasting of authentic local snacks and refreshments",
  ];
  ...
  const itinerary = [
    {
      ...
      duration: "15 min",
      description:
        "Begin your day with a convenient pickup from your hotel. Meet your expert guide and get a brief overview of Amritsar’s rich history and the day’s itinerary.",
    },
    {
                      ...
                      <div className="bg-gradient-to-r from-amber-50 to-blue-50 rounded-xl p-6 mb-6 border border-amber-100">
                        <div className="flex items-start gap-3">
                          ...
                          <p className="text-gray-700">
                            ...
                            Start early in the morning to
                            make the most of your day and
                            avoid crowds at popular
                            attractions.
                          </p>
                        </div>
                      </div>
                      <p className="text-lg text-gray-700 mb-6">
                        Embark on a comprehensive one-day
                        excursion through Amritsar's most
                        iconic sites. Begin your journey at
                        the poignant Jallianwala Bagh,
                        followed by a visit to the majestic
                        Golden Temple. Delve into the moving
                        narratives of the Partition Museum
                        before heading to the Wagah Border
                        for the electrifying evening
                        ceremony. The tour concludes with a
                        comfortable return to your hotel,
                        ensuring a memorable and hassle-free
                        experience.
                      </p>
                    ...
                    <div className="prose prose-lg max-w-none">
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <div>
                          ...
                          <ul className="space-y-3">
                            {[
                              "Expert-guided tour covering Jallianwala Bagh, Partition Museum, Golden Temple, and Wagah Border",
                        ...
                        <div>
                          ...
                          <ul className="space-y-3">
                            {[
                              ...
                              "Partition Museum ticket is exclusive",
                              "Hotel accommodation",
                            ].map((item, index) => (
                              <li
                                key={index}
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      },
                      {
                        ...
                        description:
                          "We offer customizable itineraries to suit your preferences",
                        icon: "📅",
                      },
                    ].map((feature, index) => (
                      <div
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            <div className="p-8 md:p-10">
              <h2 className="text-3xl font-bold text-white mb-4">
                Experience the Best of Amritsar in One Day
              </h2>
              <p className="text-xl text-blue-100 mb-6 max-w-xl">
                Join thousands of travelers who have
                discovered the rich history and culture of
                Amritsar through our comprehensive one-day
                tour.
              </p>
