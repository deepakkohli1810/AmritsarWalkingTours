...
const Hero = () => {
  ...
  return (
    <div className="relative w-[100%] md:w-full lg:w-full  h-[76vh]  lg:h-[90vh] rounded-3xl overflow-hidden ">
      ...
      >
        <source
          src="https://res.cloudinary.com/dmgib4rwd/video/upload/q_auto,f_auto,vc_auto/ac_none/v1750262472/HeroVideo1_umghln.mp4"
          type="video/mp4"
        />
      ...
      >
        ...
        <button
          className="bg-lightblue tracking-tight rounded-[50px] px-4 transition-colors duration-300  py-2 mt-5"
