  ...
  return (
    <div>
        <div onClick={() => navigate("/GoldenTemple")}   className="border-[1px] w-[100%] lg:w-[90%] md:w-[90%] p-1 hover:shadow-gray-700 hover:shadow-lg hover:scale-[0.9] transition-all duration-200 ease-in-out font-fredoka rounded-3xl border-lightblue shadow-md overflow-hidden">
          ...
          >
            <source src="https://res.cloudinary.com/dmgib4rwd/video/upload/q_auto,f_auto,vc_auto/ac_none/v1750484097/goldentemplecard_ohuanw.mp4" type="video/mp4"  />
          </video>
          ...
          <div className="p-4 flex justify-between items-center">
            <button onClick={() => navigate("/GoldenTemple")} className="  text-darkblue text-lg">View Details</button>
